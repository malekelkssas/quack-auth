...
| Rule                 | Path                                                                                 | Summary                                                                                                                                                            |
| -------------------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Project conventions  | [`.cursor/rules/project-conventions.mdc`](./.cursor/rules/project-conventions.mdc)   | DTOs, Mongoose, `BE_ROUTES`, BE `*.util.ts`, FE Tailwind v4, dev tools, `api/axiosConfig.ts`, Redux slices + `hooks/slices/`, layered FE flow, `@quack/mongoose/*` |
...
**New convention from Developer?** Update [`project-conventions.mdc`](./.cursor/rules/project-conventions.mdc) first, add a one-line pointer in the table above, then **must** update related Docusaurus docs (`apps/DOCS/docs/apps/frontend.md`, `backend.md`, setup pages, …) in the same branch.
